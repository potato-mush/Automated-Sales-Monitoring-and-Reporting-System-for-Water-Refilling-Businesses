        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <table class="table table-borderless">
                    ...
                    <tr>
                        <th>API Endpoint:</th>
                        <td><code><?php echo e(url('/api')); ?></code></td>
                    </tr>
                    <tr>
                        <th>Current User:</th>
                    ...
                    <tr>
                        <th>User Role:</th>
                        <td><span class="badge bg-primary"><?php echo e(ucfirst(auth()->user()->role)); ?></span></td>
                    </tr>
                </table>
            </div>
        </div>
            ...
            <div class="card-body">
                <form id="accountSettingsForm" onsubmit="updateProfile(event)">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="profileName" value="<?php echo e(auth()->user()->name); ?>" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Email Address</label>
                        <input type="email" class="form-control" id="profileEmail" value="<?php echo e(auth()->user()->email); ?>" required>
                    </div>
                    <button type="submit" class="btn btn-primary">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DarkNight_007\Downloads\Automated-Sales-Monitoring-and-Reporting-System-for-Water-Refilling-Businesses\backend\resources\views/admin/settings.blade.php ENDPATH**/ ?>